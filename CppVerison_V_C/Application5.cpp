...
GzPointer glassifyVertex(GzPointer vertexList);
GzPointer glassifyNormal(GzPointer normalList);
GzPointer glassifyUV(GzPointer uvList);
...
int Application5::Render()
{
	...
	*/
	while (fscanf(infile, "%s", dummy) == 1) { 	/* read in tri word */
		...
		//vertexGrassList[0][2] = extraGrassList[0][2];
		//vertexGrassList[1][0] = extraGrassList[1][0];
		//vertexGrassList[1][1] = extraGrassList[1][1];
		//vertexGrassList[1][2] = extraGrassList[1][2];
		//vertexGrassList[2][0] = extraGrassList[2][0];
		//vertexGrassList[2][1] = extraGrassList[2][1];
		//vertexGrassList[2][2] = extraGrassList[2][2];

		//normalGrassList[0][0] = extraGrassList[0][3];
		//normalGrassList[0][1] = extraGrassList[0][4];
		//normalGrassList[0][2] = extraGrassList[0][5];
		//normalGrassList[1][0] = extraGrassList[1][3];
		//normalGrassList[1][1] = extraGrassList[1][4];
		//normalGrassList[1][2] = extraGrassList[1][5];
		//normalGrassList[2][0] = extraGrassList[2][3];
		//normalGrassList[2][1] = extraGrassList[2][4];
		//normalGrassList[2][2] = extraGrassList[2][5];

		//uvGrassList[0][0] = extraGrassList[0][6];
		//uvGrassList[0][1] = extraGrassList[0][7];
		//uvGrassList[1][0] = extraGrassList[1][6];
		//uvGrassList[1][1] = extraGrassList[1][7];
		//uvGrassList[2][0] = extraGrassList[2][6];
		//uvGrassList[2][1] = extraGrassList[2][7];
